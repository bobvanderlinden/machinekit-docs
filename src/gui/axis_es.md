...
-   <span class="image"> ![](images/tool_zoomin.gif) </span> Zoom In
...
Figure 4. Touch Off<span id="cap:Touch-Off"></span>
...
AXIS includes a program called *machinekittop* which shows some of the details of Machinekit’s state. You can run this program by invoking Machine &gt; Show Machinekit Status
